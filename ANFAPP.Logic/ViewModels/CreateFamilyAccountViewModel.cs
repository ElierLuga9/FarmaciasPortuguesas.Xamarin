...
{
    public class CreateFamilyAccountViewModel : FamilyCardAssociationBaseViewModel
    {
        ...
        protected override bool ValidateInputs()
        {
            ...
            // Send error
            SendError(AppResources.CreateFamilyAccountErrorTitle, AppResources.CreateFamilyAccountErrorMessage);
            return false;
        }
