...
{
    public class BiometricTriglyceridesViewModel : BiometricDataViewModel<Triglycerides>
    {
        ...
        /// </summary>
        /// <returns></returns>
        protected override BiometricDataDAO<Triglycerides> InitializeDAO()
        {
            return new TriglyceridesDAO();
        }
        ...
        /// <returns></returns>
        protected override BiometricEvaluator<Triglycerides> InitializeEvaluator(Triglycerides entry)
        {
            // TODO: User!
            return new TriglyceridesEvaluator(entry, SessionData.BiometricUser);
        }
        ...
        /// </summary>
        /// <returns></returns>
        protected override Triglycerides BuildNewEntry()
        {
        ...
        protected override void InitMaxAndMinValues()
        {
            ...
            foreach (Triglycerides c in Entries)
            {
