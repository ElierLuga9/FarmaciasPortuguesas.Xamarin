...
{
    public class AddCardsToFamilyAccountViewModel : FamilyCardAssociationBaseViewModel
    {
        ...
        protected override bool ValidateInputs()
        {
            ...
            // Send error
            SendError(AppResources.AddCardsToFamilyAccountErrorTitle, AppResources.AddCardsToFamilyAccountErrorMessage);
            return false;
        }
