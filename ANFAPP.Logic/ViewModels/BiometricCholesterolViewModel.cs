...
{
    public class BiometricCholesterolViewModel : BiometricDataViewModel<Cholesterol>
    {
        ...
        /// </summary>
        /// <returns></returns>
        protected override BiometricDataDAO<Cholesterol> InitializeDAO()
        {
            return new CholesterolDAO();
        }
        ...
        /// <returns></returns>
        protected override BiometricEvaluator<Cholesterol> InitializeEvaluator(Cholesterol entry)
        {
            return new CholesterolEvaluator(entry, SessionData.BiometricUser);
        }
        ...
        /// </summary>
        /// <returns></returns>
        protected override Cholesterol BuildNewEntry()
        {
        ...
        protected override void InitMaxAndMinValues()
        {
            ...
            foreach (Cholesterol c in Entries)
            {
