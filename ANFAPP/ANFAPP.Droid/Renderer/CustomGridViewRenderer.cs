...
[assembly: ExportRenderer (typeof(XLabs.Forms.Controls.GridView), typeof(CustomGridViewRenderer))]
namespace ANFAPP.Droid.Renderer
{
	...
	/// </summary>
	public class CustomGridViewRenderer : ViewRenderer<XLabs.Forms.Controls.GridView, Android.Widget.GridView>
	{
		/// <summary>
		/// The orientation
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CustomGridViewRenderer"/> class.
		/// </summary>
		public CustomGridViewRenderer ()
		{
		}
		...
		protected override void OnConfigurationChanged (Configuration newConfig)
		{
			...
			if (newConfig.Orientation != _orientation)
				OnElementChanged (new ElementChangedEventArgs<XLabs.Forms.Controls.GridView> (this.Element, this.Element));
		}
		...
		private void Unbind (XLabs.Forms.Controls.GridView oldElement)
		{
			if (oldElement != null) {
		...
		private void Bind (XLabs.Forms.Controls.GridView newElement)
		{
			if (newElement != null) {
		...
		public  global::Android.Views.View GetCell (int position, global::Android.Views.View convertView, ViewGroup parent)
		{
			...
			view.ViewGroup.SetBackgroundColor (global::Android.Graphics.Color.Yellow);
