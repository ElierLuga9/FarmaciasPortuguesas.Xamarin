...
namespace ANFAPP
{
...
#endif
	{
        ...
        public App (bool facebookRedirect = false) 
		{
			...
			Analytics = new AnalyticsUtils(ANFAPP.Logic.Settings.GOOGLE_ANALYTICS_KEY, "Farmácias Portuguesas", "3.0.5", "pt.anf.farmaciasportuguesas", "pt.anf.farmaciasportuguesas");
