...
{
	public partial class ECProductVoucher : ContentView
	{
		public delegate Task OnTaskStartedEventHandler();
		public event OnTaskStartedEventHandler OnTaskStarted;

		public static readonly BindableProperty FromCatalogProperty = BindableProperty.Create<ECProductVoucher, bool>(p => p.FromCatalog, false);
