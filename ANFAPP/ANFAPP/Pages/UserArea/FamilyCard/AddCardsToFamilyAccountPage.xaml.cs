...
{
    public partial class AddCardsToFamilyAccountPage : ANFPage
    {
        
        #region Properties

        protected AddCardsToFamilyAccountViewModel _viewModel;

        #endregion

        #region Page Initialization

        public AddCardsToFamilyAccountPage() : base() { }
        ...
        protected override void InitPage()
        {
            ...
            BindingContext = _viewModel = new AddCardsToFamilyAccountViewModel();
        }
        ...
        async void OnSuccessEventHandler()
        {
            ...
            await DisplayAlert(
                null,
                AppResources.AddCardsToFamilyAccountSuccessMessage, 
                AppResources.OK);
        ...
        {
            return AppResources.AddCardsToFamilyAccountPageTitle;
        }
