...
{
    public partial class TutorialStep5Page : TutorialBasePage
    {

        #region Page Initialization

		public TutorialStep5Page() : base() { }
		...
		{
			NavigationUtils.PushPageAndClearHistory(new TutorialStep4Page(), Navigation);
		}

		protected override void NavigateToNext(object sender, EventArgs args)
		{
			OnDismissTutorial(null, null);
		}
